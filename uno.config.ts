...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'btn-ghost': 'inline-flex items-center gap-2 px-3 py-2 rounded-xl font-medium text-[var(--text)] hover:bg-[var(--surface-2)] transition-colors ring-focus',
  ...
  safelist: 'btn btn-ghost card container eyebrow muted prose'.split(' ')
});
